export default {
    ...
    rules: {
        // stylelint core dropped formatting rules (indentation included) in v15;
        // @stylistic/stylelint-plugin restores it. 4 spaces = the convention already
        // declared in .editorconfig for CSS/SCSS (incl. <style> blocks in .vue).
